...
class AFSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, rx_offset=6600, tx_offset=6500, uri='ip:192.168.2.1'):
        ...
        self.gain = gain = 10
        self.freq_offset = freq_offset = 6600
        ...
        self.soapy_plutosdr_source_0.set_sample_rate(0, 32*sample_rate)
        self.soapy_plutosdr_source_0.set_bandwidth(0, 32*sample_rate)
        self.soapy_plutosdr_source_0.set_gain_mode(0, True)
        self.soapy_plutosdr_source_0.set_frequency(0, int(145895000-sample_rate/4+rx_offset))
        ...
        for c in range(1, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_offset_range = Range(-10000, 10000, 1, 6600, 200)
        ...
        self.connect((self.soapy_plutosdr_source_0, 0), (self.analog_pwr_squelch_xx_0, 0))
    ...
    def set_rx_offset(self, rx_offset):
        self.rx_offset = rx_offset
        self.soapy_plutosdr_source_0.set_frequency(0, int(145895000-self.sample_rate/4+self.rx_offset))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.soapy_plutosdr_source_0.set_sample_rate(0, 32*self.sample_rate)
        self.soapy_plutosdr_source_0.set_bandwidth(0, 32*self.sample_rate)
        self.soapy_plutosdr_source_0.set_frequency(0, int(145895000-self.sample_rate/4+self.rx_offset))
